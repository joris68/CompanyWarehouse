...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        last_month = now_worktime.replace(day=1) - timedelta(days=1)  # letzter Tag des letzten Monats
        two_months_ago = last_month.replace(day=1) - timedelta(days=1)  # letzter Tag des vorletzten Monats
        first_of_two_months_ago = two_months_ago.replace(day=1)  # der 1. Tag des vorletzten Monats
